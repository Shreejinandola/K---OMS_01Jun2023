...
export default function DupliUser() {
  ...
  const getData = () => {
    ...
    get(
      GET_PurchaseOrderList +
        ...
        "?sizeperPage" +
        perPage(
          formikFilter.values.Search
            ? "&search=" + formikFilter.values.Search
            : ""
        ) +
        (formikFilter.values.SearchByColumn
          ? "&column_filter=" + formikFilter.values.SearchByColumn
          : "") +
        (formikFilter.values.Status
          ? "&status_filter=" + formikFilter.values.Status
          : "")
    )
      .then(res => {
